...
const FooterNav = () => {
 ...
 const [showAboutCompany, setShowAboutCompany] = useState(false);
  ...
  return (
    <div id="contact"  style={{background:"#23384d",color:"#c9a25b"}}>
    {isNavigating && <LoadingSpinner />}
    
    <div  className=" w-screen" style={{width:"99.5%"}}>
...
<ul className="list-none" style={{lineHeight:"2.5em",textTransform:"uppercase",color:"#c9a25b"}}>

            <ul><Link href="/" className="option-list" style={{color:"#c9a25b"}}
                       onClick={ ()=> handleLinkClick('/') } 
>PORTRAITS</Link></ul>
            <ul><Link href="/" className="option-list" style={{color:"#c9a25b"}}
                       onClick={ ()=> handleLinkClick('/') } 
>PLANS & PRICINGS</Link></ul>
            <ul><Link href="/" className="option-list" style={{color:"#c9a25b"}}
                       onClick={ ()=> handleLinkClick('/') } 
>TESTIMONIALS</Link></ul>
</ul>
        ...
        <div className="dropdown-section">
          ...
          <div className="" style={{fontSize: "10.5px", fontFamily:"Avenir Next LT W02 Regular",letterSpacing:"0.1em",color:"#c9a25b" }}>
            <h3 className="option-list" style={{ fontWeight: "bold",fontSize:"10.5px",color:"#c9a25b"}}> <Link href="/contact" onClick={ ()=> handleLinkClick('/contact') }>CONTACTS</Link></h3>
            <div className="mt-4" style={{fontSize:"9px"}}>MAIN OFFICE</div>
            <div className="mt-1" style={{color:"#c9a25b", fontWeight: "bolder",letterSpacing:"0.2em", fontFamily:"Avenir Next LT W02 Regular", fontSize:"10px"}}> <span style={{fontWeight: 900}}>(+91) 7259533331</span></div>
            <div className="mt-4" style={{fontSize:"9px"}}>CUSTOMER SERVICE</div>
            <div className="mt-1"  style={{color:"#c9a25b", fontWeight: "bolder",letterSpacing:"0.2em", fontFamily:"Avenir Next LT W02 Regular", fontSize:"10px", textTransform:"uppercase"}}>
  ...
  <a href="mailto:example@email.com" aria-label="Email">
    <FontAwesomeIcon icon={faEnvelope} color="#c9a25b" style={{width:"18px",height:"auto"}} />
  </a>
  <a href="https://instagram.com/yourprofile" aria-label="Instagram">
    <FontAwesomeIcon icon={faTelegram} color="#c9a25b" style={{width:"18px",height:"auto"}} />
  </a>
  <a href="https://www.linkedin.com/in/yourprofile" aria-label="LinkedIn">
    <FontAwesomeIcon icon={faLinkedin} color="#c9a25b" style={{width:"18px",height:"auto"}} />
  </a>
</div>
...
<div className="payment-footer" style={{   gap: "10px" }}>
  ...
  <img src="/mnp.png" alt="mnp" style={{ width: "40px", height: "auto" }} />
  {/* MedusaCTA component or other content here */}
</div>
