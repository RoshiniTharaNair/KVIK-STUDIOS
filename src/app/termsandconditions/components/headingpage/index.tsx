...
<div className="terms-div-style">
      ...
      <h1 className="mb-4 terms-heading" style={{ fontFamily: "Times New Roman,serif", fontStyle: "italic", fontWeight: 500, color: "white", textTransform: "uppercase" }}>
