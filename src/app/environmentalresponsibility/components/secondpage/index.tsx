  ...
  return (
    <div style={{ fontFamily: "Times New Roman,serif", backgroundColor: "#FFF" }}>
      ...
      <div className="flex flex-col items-center text-center pt-12 pb-12">
        ...
        At kvikstudios.com, we are committed to environmental responsibility and have implemented various initiatives to minimize our impact on the environment. Here are some specific environmental initiatives we have taken:                                        </p>
      </div>
