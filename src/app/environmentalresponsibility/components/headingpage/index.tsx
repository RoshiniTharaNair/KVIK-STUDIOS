...
const HeadingPage = () => {
  ...
  return (
<div className="environment-div-style">
      {/* Text in top left corner */}
      <div style={topLeftTextStyle}>
        <span style={homeStyle}>HOME {'>'}</span>
        <span style={paymentDeliveryStyle}> ENVIRONMENTAL RESPONSIBILITY</span>
      </div>
      
      {/* Background and Warranty Info with background image */}
      <div className="text-center" style={backgroundStyle}>
        <h1 className="mb-4 environment-heading" style={{ fontFamily: "Times New Roman,serif", fontStyle: "italic", fontWeight: 500, color: "white", textTransform: "uppercase" }}>
