  ...
  return (
    <div style={{ fontFamily: "Times New Roman,serif", backgroundColor: "#FFF" }}>
      ...
      <div className="flex flex-col items-center text-center pt-12 pb-12">
        ...
        <p className="mt-8">
        For kvikstudios.com, a tailor-made creative solution would allow customers to collaborate with our skilled artisans to create bespoke, handcrafted pieces tailored to their unique needs and preferences.                        </p>
      </div>
...
Customers can discuss their ideas and preferences with the kvikstudios.com team, who will guide them through the design process.
</p>
...
The skilled artisans at kvikstudios.com will handcraft the piece, following the approved design and using high-quality materials.
</p>
<p className="mt-5">
...
A clear agreement on the design, materials, and budget before production begins.
        ...
        <div className="mt-6" style={{fontFamily:"AvenirNextCyr-Regular", width:"63%",lineHeight:"1.3em",textAlign:"left",fontWeight:500}}>
        <p className="mt-8" >
        This tailor-made creative solution would not only enhance the customer experience but also showcase the skills and expertise of the kvikstudios.com team, setting the brand apart from its competitors.
                                            </p>
      </div>
      </div>
        </div>
