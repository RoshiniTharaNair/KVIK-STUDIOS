...
const HeadingPage = () => {
  ...
  return (
<div className="tailor-div-style">
      {/* Text in top left corner */}
      <div style={topLeftTextStyle}>
        <span style={homeStyle}>HOME {'>'}</span>
        <span style={paymentDeliveryStyle}> TAILOR MADE CREATIVE SOLUTIONS</span>
      </div>
      
      {/* Background and Warranty Info with background image */}
      <div className="text-center" style={backgroundStyle}>
        <h1 className="mb-4 tailor-heading" style={{ fontFamily: "Times New Roman,serif", fontStyle: "italic", fontWeight: 500, color: "white", textTransform: "uppercase" }}>
