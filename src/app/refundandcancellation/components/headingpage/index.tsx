...
const HeadingPage = () => {
  ...
  return (
<div className="refund-div-style">
      ...
      <div className="text-center" style={backgroundStyle}>
        <h1 className="mb-4 refund-heading" style={{ fontFamily: "Times New Roman,serif", fontStyle: "italic", fontWeight: 500, color: "white", textTransform: "uppercase" }}>
