  ...
  return (
    <div style={{ fontFamily: "Times New Roman,serif", backgroundColor: "#FFF" }}>
      ...
      <div className="flex flex-col items-center text-center pt-12 pb-12">
        ...
        <p className="mt-8">
            At kvikstudios.com, we prioritize exceptional customer service, ensuring satisfaction before and after every purchase. Our dedication lies in delivering products promptly and in pristine condition.
                        </p>
      </div>
