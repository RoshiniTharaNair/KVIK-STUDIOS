...
const paymentDeliveryStyle: CSSProperties = {
  ...
  return (
<div className="privacy-div-style">
      ...
      <h1 className="mb-4 privacy-heading" style={{ fontFamily: "Times New Roman,serif", fontStyle: "italic", fontWeight: 500, color: "white", textTransform: "uppercase" }}>
          Privacy Policy
        </h1>
      </div>
    </div>
