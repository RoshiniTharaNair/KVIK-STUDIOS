...
<div className="ship-div-style">
      ...
      <h1 className="mb-4 shipping-heading" style={{ fontFamily: "Times New Roman,serif", fontStyle: "italic", fontWeight: 500, color: "white", textTransform: "uppercase" }}>
