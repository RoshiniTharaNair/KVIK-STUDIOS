  ...
  return (
    <div style={{ fontFamily: "Times New Roman,serif", backgroundColor: "#FFF" }}>
      ...
      <div className="flex flex-col items-center text-center pt-12 pb-12">
       ...
       <p >
       At kvikstudios.com, we offer a diverse range of services, tailored to meet the unique needs of our users. When placing an order through our online platform, you can trust us for timely delivery, facilitated by our reliable third-party service providers.
                </p>
...
{/* <div className="mt-3" style={{borderBottom:"1px solid rgba(0,0,0,0.4)"}}></div> */}
        ...
        <div className="mt-6 shipping-div" style={{fontFamily:"AvenirNextCyr-Regular",textAlign:"left",fontWeight:500}}>
            <p className="mt-5">
            In case of incomplete or failed deliveries, please reach out to our dedicated customer support team at support@kvikstudios.com.
                        </p>
<div className="mt-3" style={{borderBottom:"1px solid rgba(0,0,0,0.4)"}}></div>
<p className="mt-5">
