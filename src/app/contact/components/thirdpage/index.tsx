  ...
  return (
    <div style={{ fontFamily: "Times New Roman,serif", backgroundColor: "#FFF" }}>
      <div className="flex flex-col items-center text-center pt-12 pb-12">
        <h1 className="mb-4" style={{ fontFamily: "AvenirNextCyr-Regular", color: "black", fontWeight: 500, fontSize: "32px", textTransform: "uppercase", letterSpacing: "0.2em" }}>
          CONNECT WITH US
        </h1>

        <h1 className="mb-4" style={{ fontFamily: "AvenirNextCyr-Regular", color: "black", fontWeight:  500, fontSize: "12px" }}>
