...
<div className="div-style">
      ...
      <div className="text-center" style={backgroundStyle}>
        <h1 className="text-4xl mb-3" style={{ fontSize:"32px",fontFamily: "AvenirNextCyr-Regular", fontWeight: 500, color: "white", textTransform: "uppercase",letterSpacing:"0.2em" }}>
        CONTACTS
        </h1>
        <h1 className="mb-4" style={{ fontSize:"16.5px",fontFamily: "AvenirNextCyr-Regular", fontWeight: 500, color: "white", textTransform: "uppercase",letterSpacing:"0.01em" }}>
